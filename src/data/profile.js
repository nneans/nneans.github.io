    ...
    personalProjects: [
        {
            title: "Mino",
            graphLabel: "Mino",
            subtitle: "개인 자산 및 소비 패턴 분석 플랫폼",
            affiliation: "Personal",
            period: "2025.11 ~ 2026.02",
            description: "금융 결제 내역을 자동 수집하고, 이를 공간 데이터(Spatial Data)와 매핑하여 지도 상에 시각화함으로써 사용자의 소비 행동과 지리적 패턴을 다각도로 분석할 수 있는 지능형 스마트 자산 관리 플랫폼입니다.",
        ...
        },
        {
            title: "OurLog",
            graphLabel: "OurLog",
            subtitle: "실시간 위치 기반 여행 기록 및 공유 플랫폼",
            affiliation: "Personal",
            period: "2026.02 ~ ing",
            description: "다수의 사용자가 실시간으로 여행 경로와 미디어를 지도에 매핑하고 공유할 수 있는 소셜 웹 애플리케이션입니다. Supabase의 RLS(Row Level Security)를 통한 세밀한 데이터 접근 제어 및 RPC 기반 트랜잭션 처리를 적용하여 안정적인 백엔드 아키텍처를 구축하였으며, 현재 동적인 인터랙션 기반의 최적화된 사용자 경험(UX)을 목표로 고도화 개발을 진행하고 있습니다. (개발 진행 중)",
